...
public class AntiScam extends ListenerAdapter {
    ...
    private static final String guild = "603190205393928193";
    private static final String modRole = "646291178144399371";
    private static final Long modChannel = 603587939108388864L;
