...
public class AntiScam extends ListenerAdapter {
    ...
    private static final String guild = "455919765999976461";
    private static final String modRole = "667793980318154783";
    private static final Long modChannel = 848040319781830676L;
